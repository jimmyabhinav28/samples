...
public class SampleController {
	...
	public SampleGetCallResponseModel showAllParametersInGetRequest(@RequestHeader HttpHeaders requestHeaders,
			@RequestParam Map<String, String> allQueryParameters, @PathVariable String pathParameter1,
			@PathVariable String pathParameter2) {
	...
	@ApiOperation(value = "", response = SampleGetCallResponseModel.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Successfully parsed all parameters"),
			// @ApiResponse(code = 401, message = "You are not authorized to view the
			// resource"),
			// @ApiResponse(code = 403, message = "Accessing the resource you were trying to
			// reach is forbidden"),
	...
	public SamplePostCallResponseModel showAllParametersInPostRequest(@RequestHeader HttpHeaders requestHeaders,
			@RequestParam Map<String, String> allQueryParameters, @PathVariable String pathParameter1,
			@PathVariable String pathParameter2, @RequestBody String requestBody) {
